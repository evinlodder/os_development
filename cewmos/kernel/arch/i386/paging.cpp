...
static page_table* tables[kernel::PD_SIZE] {};
...
void kernel::init_paging(uintptr_t dir, uintptr_t start_table, size_t start_idx) {
    directory = (page_directory*)dir;
    tables[start_idx] = (page_table*)start_table;
