...
boot_fixed_allocbuffer:
	.skip 4194304 //4 MiB for memory allocation later on
...
2:
	...
	addl $4, %edi
    #if %edi is overflowing, set it back to zero and change the active page table to boot_page_table2
    cmpl %edi, %ecx
    je 5f
	# Loop to the next entry if we haven't finished.
	loop 1b
5:
    movl $(boot_page_table2 - 0xC0000000), %edi #set edi to use boot page table 2
    loop 1b
3:
