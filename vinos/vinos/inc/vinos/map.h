...
#include <stdint.h>
#include <vinos/hash.h>
#include <vinos/pair.h>
...
template <typename Key, typename Value, typename Hash = vinos::hash<Key>, size_t Size = 255>
class map {
public:
    using key_type = Key;
    using mapped_type = Value;
    using value_type = vinos::pair<Key, Value>;
